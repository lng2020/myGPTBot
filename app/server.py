...
temp_whitelist_channel_id = 'C050DF4R5DM'

limiter_message_per_user = 100
...
def handle_mentions(event, say, logger):
    ...
    if channel == temp_whitelist_channel_id:
    ...
    if "text" in event:
        update_thread_history(parent_thread_ts, f'User: {format_dialog_text(event["text"])}', extract_urls_from_event(event))
